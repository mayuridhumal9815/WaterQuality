...
image2 = image2.resize((1730,1000), Image.ANTIALIAS)
...
label_l1 = tk.Label(root, text="Water Quality Prediction",font=("Times New Roman", 35, 'bold'),
                    background="brown", fg="white", width=65, height=1)
